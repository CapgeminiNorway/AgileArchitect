...
<html lang="en" class=" is-copy-enabled is-u2f-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta property="fb:app_id" content="1401488693436528">
      ...
      <meta content="https://avatars2.githubusercontent.com/u/19644120?v=3&amp;s=400" name="twitter:image:src" /><meta content="@github" name="twitter:site" /><meta content="summary" name="twitter:card" /><meta content="CapgeminiNorway/Architecture" name="twitter:title" /><meta content="The Agile Architecture Academy" name="twitter:description" />
      <meta content="https://avatars2.githubusercontent.com/u/19644120?v=3&amp;s=400" property="og:image" /><meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="CapgeminiNorway/Architecture" property="og:title" /><meta content="https://github.com/CapgeminiNorway/Architecture" property="og:url" /><meta content="The Agile Architecture Academy" property="og:description" />
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="html-safe-nonce" content="42b584cd0c9c850866eeb656a02c24264fe581c2">
    <meta content="9828a558a4294079e33b77cf229533fb26f9b27e" name="form-nonce" />

    <meta http-equiv="x-pjax-version" content="7ca106dd8d4396d47796a4f7b714d8c7">
    

      
  <meta name="description" content="The Agile Architecture Academy">
  <meta name="go-import" content="github.com/CapgeminiNorway/Architecture git https://github.com/CapgeminiNorway/Architecture.git">

  <meta content="19644120" name="octolytics-dimension-user_id" /><meta content="CapgeminiNorway" name="octolytics-dimension-user_login" /><meta content="59986797" name="octolytics-dimension-repository_id" /><meta content="CapgeminiNorway/Architecture" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="59986797" name="octolytics-dimension-repository_network_root_id" /><meta content="CapgeminiNorway/Architecture" name="octolytics-dimension-repository_network_root_nwo" />
  ...
  <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/CapgeminiNorway/Architecture/search" class="js-site-search-form" data-scoped-search-url="/CapgeminiNorway/Architecture/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
...
<ul class="header-nav user-nav right" id="user-links">
  <li class="header-nav-item">
    ...
    <a href="/notifications" aria-label="You have no unread notifications" class="header-nav-link notification-indicator tooltipped tooltipped-s js-socket-channel js-notification-indicator" data-channel="tenant:1:notification-changed:11663586" data-ga-click="Header, go to notifications, icon:read" data-hotkey="g n">
...
<a class="dropdown-item" href="/new" data-ga-click="Header, create new repository">
  ...
  <div class="dropdown-header">
    <span title="CapgeminiNorway">This organization</span>
  </div>
  <a class="dropdown-item" href="/orgs/CapgeminiNorway/invitations/new" data-ga-click="Header, invite someone">
    Invite someone
  </a>
  <a class="dropdown-item" href="/orgs/CapgeminiNorway/new-team" data-ga-click="Header, create new team">
    New team
  </a>
  <a class="dropdown-item" href="/organizations/CapgeminiNorway/repositories/new" data-ga-click="Header, create new organization repository, icon:repo">
    New repository
  </a>
  ...
  <div class="dropdown-divider"></div>
  <div class="dropdown-header">
    <span title="CapgeminiNorway/Architecture">This repository</span>
  </div>
    <a class="dropdown-item" href="/CapgeminiNorway/Architecture/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
    <a class="dropdown-item" href="/CapgeminiNorway/Architecture/settings/collaboration" data-ga-click="Header, create new collaborator">
      New collaborator
    </a>
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-sw js-menu-target" href="/thellef"
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">thellef</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/thellef" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
...
<ul class="pagehead-actions">
  ...
  <li>
        ...
        <div class="select-menu js-menu-container js-select-menu">
          ...
          <a class="social-count js-social-count" href="/CapgeminiNorway/Architecture/watchers">
            3
          </a>
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/CapgeminiNorway/Architecture/unstar" class="starred" data-form-nonce="9828a558a4294079e33b77cf229533fb26f9b27e" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="6EUFFvgK0N3n2R2gXWpIRhhqMEeZHJqwub1YsF38wDLCBhQBYJz03dYL/Z8spHlf81A4LAZT5KSqkY+b9QRtRw==" /></div>
      <button
        ...
        <a class="social-count js-social-count" href="/CapgeminiNorway/Architecture/stargazers">
          0
        </a>
</form>
  ...
  <li>
          <a href="#fork-destination-box" class="btn btn-sm btn-with-count"
              title="Fork your own copy of CapgeminiNorway/Architecture to your account"
              aria-label="Fork your own copy of CapgeminiNorway/Architecture to your account"
              rel="facebox"
          ...
          <div id="fork-destination-box" style="display: none;">
            ...
            <include-fragment src=""
                ...
                data-url="/CapgeminiNorway/Architecture/fork?fragment=1">
              <img alt="Loading" height="64" src="https://assets-cdn.github.com/images/spinners/octocat-spinner-128.gif" width="64" />
            </include-fragment>
          </div>

    <a href="/CapgeminiNorway/Architecture/network" class="social-count">
      1
    </a>
  </li>
</ul>
  ...
  <span class="author" itemprop="author"><a href="/CapgeminiNorway" class="url fn" rel="author">CapgeminiNorway</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a href="/CapgeminiNorway/Architecture" data-pjax="#js-repo-pjax-container">Architecture</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/CapgeminiNorway/Architecture" aria-selected="true" class="js-selected-navigation-item selected reponav-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /CapgeminiNorway/Architecture" itemprop="url">
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a href="/CapgeminiNorway/Architecture/issues" class="js-selected-navigation-item reponav-item" data-hotkey="g i" data-selected-links="repo_issues repo_labels repo_milestones /CapgeminiNorway/Architecture/issues" itemprop="url">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/CapgeminiNorway/Architecture/pulls" class="js-selected-navigation-item reponav-item" data-hotkey="g p" data-selected-links="repo_pulls /CapgeminiNorway/Architecture/pulls" itemprop="url">
  ...
  <a href="/CapgeminiNorway/Architecture/pulse" class="js-selected-navigation-item reponav-item" data-selected-links="pulse /CapgeminiNorway/Architecture/pulse">
    <svg aria-hidden="true" class="octicon octicon-pulse" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path d="M11.5 8L8.8 5.4 6.6 8.5 5.5 1.6 2.38 8H0v2h3.6l.9-1.8.9 5.4L9 8.5l1.6 1.5H14V8z"></path></svg>
    Pulse
</a>
  <a href="/CapgeminiNorway/Architecture/graphs" class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors /CapgeminiNorway/Architecture/graphs">
    <svg aria-hidden="true" class="octicon octicon-graph" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path d="M16 14v1H0V0h1v14h15zM5 13H3V8h2v5zm4 0H7V3h2v10zm4 0h-2V6h2v7z"></path></svg>
    Graphs
</a>
    <a href="/CapgeminiNorway/Architecture/settings" class="js-selected-navigation-item reponav-item" data-selected-links="repo_settings repo_branch_settings hooks /CapgeminiNorway/Architecture/settings">
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu left">
  <button class="btn btn-sm select-menu-button js-menu-target css-truncate" data-hotkey="w"
    ...
    <i>Tree:</i>
    <span class="js-select-button css-truncate-target">e5b2752a88</span>
  </button>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               ...
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"></path></svg>
              <span class="select-menu-item-text css-truncate-target js-select-menu-filter-text" title="johnerik">
                johnerik
              </span>
            </a>
            <a class="select-menu-item js-navigation-item js-navigation-open "
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               ...
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"></path></svg>
              <span class="select-menu-item-text css-truncate-target js-select-menu-filter-text" title="rugged">
                rugged
              </span>
            </a>
            <a class="select-menu-item js-navigation-item js-navigation-open "
               ...
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"></path></svg>
              <span class="select-menu-item-text css-truncate-target js-select-menu-filter-text" title="sarina">
                sarina
              </span>
            </a>
        </div>
          ...
          <svg aria-hidden="true" class="octicon octicon-git-branch select-menu-item-icon" height="16" version="1.1" viewBox="0 0 10 16" width="10"><path d="M10 5c0-1.11-.89-2-2-2a1.993 1.993 0 0 0-1 3.72v.3c-.02.52-.23.98-.63 1.38-.4.4-.86.61-1.38.63-.83.02-1.48.16-2 .45V4.72a1.993 1.993 0 0 0-1-3.72C.88 1 0 1.89 0 3a2 2 0 0 0 1 1.72v6.56c-.59.35-1 .99-1 1.72 0 1.11.89 2 2 2 1.11 0 2-.89 2-2 0-.53-.2-1-.53-1.36.09-.06.48-.41.59-.47.25-.11.56-.17.94-.17 1.05-.05 1.95-.45 2.75-1.25S8.95 7.77 9 6.73h-.02C9.59 6.37 10 5.73 10 5zM2 1.8c.66 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2C1.35 4.2.8 3.65.8 3c0-.65.55-1.2 1.2-1.2zm0 12.41c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm6-8c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2z"></path></svg>
            <div class="select-menu-item-text">
              ...
              <span class="description">from ‘e5b2752’</span>
            </div>
  ...
  <div class="btn-group right">
    <a href="/CapgeminiNorway/Architecture/find/e5b2752a88a0dfb1acd91769c3e8dc2e738a752e"
